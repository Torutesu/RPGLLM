...
/* The review digest in the gate (docs/moderation.md §3): its checks, its frozen case set of
 * damaged worlds, and the run that scores them. No judge — a digest has a right answer. */
export {
  machineChecksDigest,
  confidenceAllowed,
  runEvalDigest,
  DIGEST_ABSOLUTE_CHECKS,
  type DigestCaseScore,
  type DigestEvalArgs,
  type DigestEvalResult,
} from "./eval-digest.js";
export {
  caseWorld,
  frozenEvalCasesDigest,
  DAMAGES,
  type Damage,
  type DigestEvalCaseSpec,
} from "./eval-cases-digest.js";

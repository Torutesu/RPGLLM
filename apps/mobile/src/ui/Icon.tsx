...
const paths = {
  ...
  bell: {
    s: ["M18 8.4a6 6 0 1 0-12 0c0 5.2-2.1 6.4-2.1 6.4h16.2S18 13.6 18 8.4", "M13.7 19a2 2 0 0 1-3.4 0"],
  },
  message: {
    s: [
  ...
  person: {
    s: [
      "M20 21v-1.8a4.2 4.2 0 0 0-4.2-4.2H8.2A4.2 4.2 0 0 0 4 19.2V21",
      "M16.2 7.2a4.2 4.2 0 1 1-8.4 0 4.2 4.2 0 0 1 8.4 0z",
    ],
  },
  compass: {
  ...
  heart: {
    s: [
      "M20.6 5.1a5.3 5.3 0 0 0-7.5 0L12 6.2l-1.1-1.1a5.3 5.3 0 1 0-7.5 7.5l1.1 1.1L12 21.2l7.5-7.5 1.1-1.1a5.3 5.3 0 0 0 0-7.5z",
    ],
  },
  heartFilled: {
    f: [
  ...
  repost: {
    s: [
      "M17 2.6 20.8 6.4 17 10.2",
      "M3.2 12.4V9.6a3.2 3.2 0 0 1 3.2-3.2h14.4",
      "M7 21.4 3.2 17.6 7 13.8",
      "M20.8 11.6v2.8a3.2 3.2 0 0 1-3.2 3.2H3.2",
    ],
  },
  reply: {
  ...
  play: {
    s: ["M8.2 4.6 19.4 12 8.2 19.4z"],
    f: ["M8.2 4.6 19.4 12 8.2 19.4z"],
  },
  download: {
    s: ["M4.4 12.4V19a2 2 0 0 0 2 2h11.2a2 2 0 0 0 2-2v-6.6", "M8 11.2 12 15.2l4-4", "M12 15.2V2.8"],
  },
  bolt: { s: ["M13.4 2.4 4.6 13.8h6.4l-1.4 7.8 8.8-11.4H12z"] },
  coffee: {
    s: [
      "M18 8.6h1.2a3.6 3.6 0 0 1 0 7.2H18",
      "M2.8 8.6H18v8.2a4.2 4.2 0 0 1-4.2 4.2H7a4.2 4.2 0 0 1-4.2-4.2z",
      "M6.6 2.2v2.8",
      "M10.4 2.2v2.8",
      "M14.2 2.2v2.8",
    ],
  ...
  trophy: {
    s: [
      "M8.4 21.2h7.2",
      "M12 17.4v3.8",
      "M7 3.2h10v5.4a5 5 0 0 1-10 0z",
      "M7 5.6H5.2a2.2 2.2 0 0 0 0 4.4H7",
      "M17 5.6h1.8a2.2 2.2 0 0 1 0 4.4H17",
    ],
  },
  crown: {
  ...
  eye: {
    s: [
      "M2.2 12s3.6-6.8 9.8-6.8S21.8 12 21.8 12s-3.6 6.8-9.8 6.8S2.2 12 2.2 12z",
  ...
  thumbUp: {
    s: [
      "M7 21.4H4.4a1.2 1.2 0 0 1-1.2-1.2v-7.6a1.2 1.2 0 0 1 1.2-1.2H7",
      "M7 11.4l3.9-8.8a2.9 2.9 0 0 1 2.9 2.9v3.9h5.4a2 2 0 0 1 2 2.3l-1.3 6.8a2 2 0 0 1-2 1.9H7z",
    ],
  },
  thumbDown: {
    s: [
      "M17 2.6h2.6a1.2 1.2 0 0 1 1.2 1.2v7.6a1.2 1.2 0 0 1-1.2 1.2H17",
      "M17 12.6l-3.9 8.8a2.9 2.9 0 0 1-2.9-2.9v-3.9H4.8a2 2 0 0 1-2-2.3l1.3-6.8a2 2 0 0 1 2-1.9H17z",
    ],
  },
  ...
  refresh: {
    s: [
      "M20.4 4.4v5.2h-5.2",
      "M3.6 19.6v-5.2h5.2",
      "M19.1 9.6a7.6 7.6 0 0 0-13-2.9L3.6 9.6",
      "M4.9 14.4a7.6 7.6 0 0 0 13 2.9l2.5-2.9",
    ],
  },
    ...
    >
      {solid.map((d, i) => (
        <Path
          ...
          fill={color}
          stroke={color}
          strokeWidth={filled ? STROKE * 0.5 : 0}

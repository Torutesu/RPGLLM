...
const bibleEn = [
  ...
  "- @gmz — the press account. Third person, breathless headlines, 'sources say'. Never friendly, never wrong on purpose.",
  "",
  "## Rules of the world",
...
const bibleJa = [
  ...
  "- @gmz — 報道アカウント。三人称、息せき切った見出し、「関係者によると」。友好的ではない。",
  "",
  "## 世界のルール",
...
const ambientEn: { handle: string; text: string }[] = [
  ...
  { handle: "@gmz", text: "SOURCES: a certain studio booked three nights in a row. draw your own conclusions." },
  ...
  { handle: "@gmz", text: "BREAKING: the charts moved and nobody can explain why" },
  { handle: "@the6ixdrey", text: "hot take: the demo was better" },
  { handle: "@hivequeenbea", text: "posting through it. as one does. 🐝" },
  { handle: "@gmz", text: "EXCLUSIVE: an unreleased snippet is circulating in three group chats" },
  { handle: "@the6ixdrey", text: "second verse energy on a first verse budget" },
  { handle: "@hivequeenbea", text: "ok but the outfit. the OUTFIT." },
  { handle: "@gmz", text: "REPORT: label insiders describe the release plan as 'chaotic but working'" },
  ...
  { handle: "@gmz", text: "SOURCES: a rehearsal ran until 4am. no one has commented." },
  ...
  { handle: "@gmz", text: "SHOCKER: an old interview clip is trending again for no reason" },
  ...
  { handle: "@gmz", text: "UPDATE: the venue added a second night" },
];
...
export const FALLBACK_WORLD_SEED: WorldSeed = {
  ...
  cast: [
    ...
    {
      handle: "@gmz", displayName: "GMZ", role: "press", isPressAccount: true, canBeFirstFollower: false, avatarKey: "gmz",
      card: {
